...
public class DatRemakeAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		String text=request.getParameter("inputtext"+d_code);
		...
		boolean remakeSuccess = boardContentDatService.DatRemake(text,d_code);
